function Class12() {
  ...
  {
    id: 1,
    type: ['RECORDED', 'SCHOLARSHIP ELIGIBLE'],
    title: 'Enthusiast Self – Study Plus',
  ...
  },
  {
    id: 2,
    type: ['RECORDED'],
    title: 'Enthusiast Self–Study Classic',
...
const practicePackage = [
  {
    id: 1,
    type: ['PRACTICE'],
    title: 'Enthusiast Practice Package',
